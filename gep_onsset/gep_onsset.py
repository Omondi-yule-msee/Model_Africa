...
class Technology:
    ...
    def __init__(self,
                 ...
                 discount_rate, #code_updated #ETHupdate
        ...
        self.discount_rate = discount_rate  # Code_updated ETHUpdate

    @classmethod
    def set_default_values(cls, base_year, start_year, end_year, dummy, HV_line_type=69, HV_line_cost=53000,#Code_updated#ETHupdate
        ...
        #cls.discount_rate = discount_rate #Code updated_remove cls#ETHupdate
    ...
    def get_lcoe(self, energy_per_cell, people, num_people_per_hh, start_year, end_year, new_connections,
                 ...
                 get_capacity=False,get_salvage_cost = False,get_om_cost = False):
        """
    ...
    def __init__(self, path):
        ...
        try:
            ...
            try:
                ...
                raise
    def Replace_PerCapitaDemand_Val(self): #Code_updated added this function#ETHupdate
        """
